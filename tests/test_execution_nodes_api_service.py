...
class TestGetGraphExecutionState:
    ...
    def test_no_children_returns_empty_stats(self):
        ...
        assert result.summary.ended_executions == 0
        assert result.summary.has_ended is True
    ...
    def test_direct_container_children(self):
        ...
        assert result.summary.ended_executions == 1
    ...
    def test_three_level_mixed_stats(self):
        ...
        # Total = 3 + 6 = 9
        assert result.summary.total_executions == 9
        ...
        # Total ended = 2 + 5 = 7
        assert result.summary.ended_executions == 7
        assert result.summary.has_ended is False
