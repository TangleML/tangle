...
def _set_terminal_state(
    *,
    ...
    """Persist terminal state fields on a container execution.

    Called when a container execution reaches a terminal state.  Saving
    ended_at, exit_code, and started_at at terminal time is important so the
    API can report when the execution finished and what happened.
    """
