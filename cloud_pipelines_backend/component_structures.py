...
class InputValuePlaceholder(_BaseModel):  # Non-standard attr names
    ...
    __pydantic_config__ = _default_pydantic_config | pydantic.ConfigDict(
        alias_generator=lambda s: (
            InputValuePlaceholder._serialized_names.get(s) or pydantic.alias_generators.to_camel(s)
        ),
    )
...
class InputPathPlaceholder(_BaseModel):  # Non-standard attr names
    ...
    __pydantic_config__ = _default_pydantic_config | pydantic.ConfigDict(
        alias_generator=lambda s: (
            InputPathPlaceholder._serialized_names.get(s) or pydantic.alias_generators.to_camel(s)
        ),
    )
    input_name: str
...
class OutputPathPlaceholder(_BaseModel):  # Non-standard attr names
    ...
    __pydantic_config__ = _default_pydantic_config | pydantic.ConfigDict(
        alias_generator=lambda s: (
            OutputPathPlaceholder._serialized_names.get(s) or pydantic.alias_generators.to_camel(s)
        ),
    )
    output_name: str
...
class IfPlaceholderStructure(_BaseModel):  # Non-standard attr names
    ...
    __pydantic_config__ = _default_pydantic_config | pydantic.ConfigDict(
        alias_generator=lambda s: (
            IfPlaceholderStructure._serialized_names.get(s) or pydantic.alias_generators.to_camel(s)
        ),
    )
...
class IfPlaceholder(_BaseModel):  # Non-standard attr names
    ...
    __pydantic_config__ = _default_pydantic_config | pydantic.ConfigDict(
        alias_generator=lambda s: IfPlaceholder._serialized_names.get(s) or pydantic.alias_generators.to_camel(s),
    )
...
ArgumentType = Union[PrimitiveTypes, GraphInputArgument, TaskOutputArgument, DynamicDataArgument]
